      ...
      <article className="card-manga group flex h-full flex-col">
        <div className="relative aspect-[3/4] overflow-hidden">
          ...
          <div className="absolute left-3 top-3 flex flex-wrap gap-1.5">
            ...
            <span className="chip">{manga.demographic}</span>
          </div>
          <div className="absolute right-3 top-3">
            <span className="chip bg-background/70 backdrop-blur">{manga.status}</span>
          </div>
        </div>
        <div className="flex flex-1 flex-col gap-3 p-4">
          <div className="flex items-start justify-between gap-3">
            <div className="min-w-0">
              ...
              <p className="truncate text-xs text-muted-foreground">by {manga.creator}</p>
            </div>
